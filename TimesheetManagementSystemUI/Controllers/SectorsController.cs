...
namespace TimesheetManagementSystemUI.Controllers
{
    public class SectorsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                using (var response = await httpClient.GetAsync("http://localhost:5283/api/Sectors/Get"))
                {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var response = await httpClient.GetAsync("http://localhost:5283/api/Sectors/Details/" + id))
        ...
        public IActionResult Create(Sector sector)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var postTask = httpClient.PostAsJsonAsync<Sector>("http://localhost:5283/api/Sectors/Create/", sector);
                postTask.Wait();
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            HttpResponseMessage responseMessage = await client.GetAsync("http://localhost:5283/api/Sectors/Details/" + id);
        ...
        public async Task<ActionResult> Edit(int id, Sector Sec)
        {
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage responseMessage = await client.PutAsJsonAsync("http://localhost:5283/api/Sectors/Edit/" + id, Sec);
                if (responseMessage.IsSuccessStatusCode)
                {
                    return RedirectToAction("Index");
                }
