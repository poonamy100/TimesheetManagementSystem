...
namespace TimesheetManagementSystemUI.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //await _userManager.AddClaimAsync(user, new("Admin","Admin"));
        ...
        private async Task<AppUser> CreateUser()
        {
            try
            {
                AppUser user = new AppUser()
                {
                    ...
                    Location = await _context.Locations.FirstOrDefaultAsync(k=>k.Id == LocationId)
                };
                return user;
            }
            catch
